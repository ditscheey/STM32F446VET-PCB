...
U 1 1 5F722016
P 9025 6175
F 0 "#PWR033" H 9025 5925 50  0001 C CNN
...
$Comp
L STMF4_BreadBoardBreakout-rescue:+5V-power-STMF4_BreadBoardBreakout-rescue #PWR021
U 1 1 5F764202
P 1550 5475
F 0 "#PWR021" H 1550 5325 50  0001 C CNN
...
U 1 1 5F70CBEE
P 2250 5775
F 0 "#PWR023" H 2250 5525 50  0001 C CNN
...
NoConn ~ 975  4075
NoConn ~ 2475 4150
Text Notes 3525 6425 0    50   ~ 10
DCMI for camera\n
$Comp
L Connector_Generic:Conn_02x09_Odd_Even J8
U 1 1 5F4CB7AB
P 3550 5600
F 0 "J8" V 4175 5150 50  0000 L CNN
F 1 "DCMI SPI CAM" V 4250 5100 50  0000 L CNN
...
U 1 1 5F5027F2
P 3050 5950
F 0 "#PWR024" H 3050 5700 50  0001 C CNN
...
$EndComp
$Comp
L STMF4_BreadBoardBreakout-rescue:+3.3V-power-STMF4_BreadBoardBreakout-rescue #PWR025
U 1 1 5F505817
P 3100 5300
...
F 3 "~" H 2275 3350 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 3925 3575 1    50   Input ~ 0
I2C3_SDA
...
$EndComp
$Comp
L STMF4_BreadBoardBreakout-rescue:+3.3V-power-STMF4_BreadBoardBreakout-rescue #PWR031
U 1 1 5F5BA5A6
P 5150 5825
F 0 "#PWR031" H 5150 5675 50  0001 C CNN
...
U 1 1 5F5B661C
P 5675 6050
F 0 "#PWR032" H 5675 5800 50  0001 C CNN
F 1 "GND" H 5680 5877 50  0000 C CNN
...
I2C3_SDA
$Comp
L STMF4_BreadBoardBreakout-rescue:GND-power-STMF4_BreadBoardBreakout-rescue #PWR020
U 1 1 5F6B0980
P 1000 1375
F 0 "#PWR020" H 1000 1125 50  0001 C CNN
...
$EndComp
$Comp
L STMF4_BreadBoardBreakout-rescue:+3.3V-power-STMF4_BreadBoardBreakout-rescue #PWR027
U 1 1 5F6B7A7D
P 3325 1075
F 0 "#PWR027" H 3325 925 50  0001 C CNN
...
$EndComp
$Comp
L STMF4_BreadBoardBreakout-rescue:GND-power-STMF4_BreadBoardBreakout-rescue #PWR022
U 1 1 5F6E039D
P 2075 1375
F 0 "#PWR022" H 2075 1125 50  0001 C CNN
...
U 1 1 5F6E6D1C
P 3125 1425
F 0 "#PWR026" H 3125 1175 50  0001 C CNN
...
Wire Wire Line
	2075 1375 2225 1375
$Comp
L STMF4_BreadBoardBreakout-rescue:+3.3V-power-STMF4_BreadBoardBreakout-rescue #PWR029
U 1 1 5F6F829F
P 4225 925
F 0 "#PWR029" H 4225 775 50  0001 C CNN
...
U 1 1 5F6F8861
P 4175 1475
F 0 "#PWR028" H 4175 1225 50  0001 C CNN
...
Wire Notes Line
	2950 4950 4200 4950
Text GLabel 4975 4950 0    50   Input ~ 0
PWDN
Text GLabel 4975 5150 0    50   Input ~ 0
VS
Text GLabel 4975 5250 0    50   Input ~ 0
MCLK
Text GLabel 4975 5050 0    50   Input ~ 0
HS
Text GLabel 4975 4850 0    50   Input ~ 0
RESET
Wire Wire Line
	4975 4850 4975 4875
$Comp
...
U 1 1 5F5595A2
P 4975 4875
F 0 "#PWR030" H 4975 4625 50  0001 C CNN
...
Wire Wire Line
	4975 4875 4975 5250
Text GLabel 8975 625  2    50   Input ~ 0
+3.3V
$Comp
...
Wire Wire Line
	5150 6025 5675 6025
Text Notes 4975 4600 0    50   ~ 10
TODO READ DATASHEET OV7670\n
$EndSCHEMATC
